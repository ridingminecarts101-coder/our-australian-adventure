...
1. **Wait for Apple order processing, then confirm activation.** The owner has placed the individual/sole-trader membership order and confirms it is still being processed. Developer/signing and publishing access are not active yet. Once Apple confirms activation, sign in and verify App Store Connect access. The owner has sent Apple an enquiry about a possible later conversion; conversion is optional and is not an initial upload-preparation gate.
